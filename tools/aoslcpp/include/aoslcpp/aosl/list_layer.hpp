...
/**
 * @file
 * @brief Generated from list_layer.xsd.
 */

#ifndef AOSLCPP_AOSL__LIST_LAYER_HPP
#define AOSLCPP_AOSL__LIST_LAYER_HPP
...
{
  /**
   * @brief Class corresponding to the %list_layer schema type.
   *
   * List of Layers.
   *
   * @nosubgrouping
   */
  class AOSLCPP_API List_layer: public ::xml_schema::Type
  {
    public:
    /**
     * @name layer
  ...
  AOSLCPP_API
  bool
  operator== (const List_layer&, const List_layer&);
...
namespace aosl
{
  AOSLCPP_API
  ::std::ostream&
  operator<< (::std::ostream&, const List_layer&);
}
...
namespace aosl
{
  AOSLCPP_API
  void
  operator<< (::xercesc::DOMElement&, const List_layer&);
}
...
#endif // AOSLCPP_AOSL__LIST_LAYER_HPP
