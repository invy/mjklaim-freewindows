...
/**
 * @file
 * @brief Generated from list_change.xsd.
 */

#ifndef AOSLCPP_AOSL__LIST_CHANGE_HPP
#define AOSLCPP_AOSL__LIST_CHANGE_HPP
...
{
  /**
   * @brief Class corresponding to the %list_change schema type.
   *
   * List of changes.
   *
   * @nosubgrouping
   */
  class AOSLCPP_API List_change: public ::xml_schema::Type
  {
    public:
    /**
     * @name change
     ...
     * instance.
     */
    List_change (const ::xercesc::DOMElement& e,
     ...
     */
    List_change (const List_change& x,
                 ::xml_schema::Flags f = 0,
                 ::xml_schema::Container* c = 0);
  ...
  AOSLCPP_API
  bool
  operator== (const List_change&, const List_change&);
...
namespace aosl
{
  AOSLCPP_API
  ::std::ostream&
  operator<< (::std::ostream&, const List_change&);
}
...
namespace aosl
{
  AOSLCPP_API
  void
  operator<< (::xercesc::DOMElement&, const List_change&);
}
...
#endif // AOSLCPP_AOSL__LIST_CHANGE_HPP
