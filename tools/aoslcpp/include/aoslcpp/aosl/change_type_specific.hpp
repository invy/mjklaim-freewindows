...
/**
 * @file
 * @brief Generated from change_type_specific.xsd.
 */

#ifndef AOSLCPP_AOSL__CHANGE_TYPE_SPECIFIC_HPP
#define AOSLCPP_AOSL__CHANGE_TYPE_SPECIFIC_HPP
...
{
  /**
   * @brief Class corresponding to the %change_type_specific schema type.
   *
   * Interpreter-specific change type : should be prefixed by '!' .
   *
   * @nosubgrouping
   */
  class Change_type_specific: public ::xml_schema::String
  {
     ...
     */
    Change_type_specific (const char*);

    /**
     * @brief Create an instance from a string andinitializers
     * for required elements and attributes.
     */
    Change_type_specific (const ::std::string&);

    /**
     * @brief Create an instance from the ultimate base and
     * initializers for required elements and attributes.
     */
    Change_type_specific (const ::xml_schema::String&);
...
#endif // AOSLCPP_AOSL__CHANGE_TYPE_SPECIFIC_HPP
