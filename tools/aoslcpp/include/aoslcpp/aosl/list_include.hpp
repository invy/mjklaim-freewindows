...
/**
 * @file
 * @brief Generated from list_include.xsd.
 */

#ifndef AOSLCPP_AOSL__LIST_INCLUDE_HPP
#define AOSLCPP_AOSL__LIST_INCLUDE_HPP
...
{
  /**
   * @brief Class corresponding to the %list_include schema type.
   *
   * List of includes.
   *
   * @nosubgrouping
   */
  class AOSLCPP_API List_include: public ::xml_schema::Type
  {
    public:
    /**
     * @name include
  ...
  AOSLCPP_API
  bool
  operator== (const List_include&, const List_include&);
...
namespace aosl
{
  AOSLCPP_API
  ::std::ostream&
  operator<< (::std::ostream&, const List_include&);
}
...
namespace aosl
{
  AOSLCPP_API
  void
  operator<< (::xercesc::DOMElement&, const List_include&);
}
...
#endif // AOSLCPP_AOSL__LIST_INCLUDE_HPP
