...
/**
 * @file
 * @brief Generated from list_object.xsd.
 */

#ifndef AOSLCPP_AOSL__LIST_OBJECT_HPP
#define AOSLCPP_AOSL__LIST_OBJECT_HPP
...
{
  /**
   * @brief Class corresponding to the %list_object schema type.
   *
   * List of Objects.
   *
   * @nosubgrouping
   */
  class AOSLCPP_API List_object: public ::xml_schema::Type
  {
    public:
    /**
     * @name object
     ...
     * instance.
     */
    List_object (const ::xercesc::DOMElement& e,
     ...
     */
    List_object (const List_object& x,
                 ::xml_schema::Flags f = 0,
                 ::xml_schema::Container* c = 0);
  ...
  AOSLCPP_API
  bool
  operator== (const List_object&, const List_object&);
...
namespace aosl
{
  AOSLCPP_API
  ::std::ostream&
  operator<< (::std::ostream&, const List_object&);
}
...
namespace aosl
{
  AOSLCPP_API
  void
  operator<< (::xercesc::DOMElement&, const List_object&);
}
...
#endif // AOSLCPP_AOSL__LIST_OBJECT_HPP
