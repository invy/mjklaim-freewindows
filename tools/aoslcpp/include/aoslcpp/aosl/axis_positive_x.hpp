...
/**
 * @file
 * @brief Generated from axis_positive_x.xsd.
 */

#ifndef AOSLCPP_AOSL__AXIS_POSITIVE_X_HPP
#define AOSLCPP_AOSL__AXIS_POSITIVE_X_HPP
...
{
  /**
   * @brief Enumeration class corresponding to the %axis_positive_x
   * schema type.
   *
  ...
  class AOSLCPP_API Axis_positive_x: public ::xml_schema::String
  {
    ...
    {
      /**
       * The x-axis positive values are on the left of the display from the
       * origin point.
       */
      left,
      /**
       * The x-axis positive values are on the right of the display from the
       * origin point.
       */
      right
    };
     ...
     */
    Axis_positive_x (const Axis_positive_x& x,
                     ::xml_schema::Flags f = 0,
                     ::xml_schema::Container* c = 0);
    ...
    {
      return _xsd_Axis_positive_x_convert ();
    }
    ...
    public:
    static const char* const _xsd_Axis_positive_x_literals_[2];
    static const Value _xsd_Axis_positive_x_indexes_[2];
...
#endif // AOSLCPP_AOSL__AXIS_POSITIVE_X_HPP
