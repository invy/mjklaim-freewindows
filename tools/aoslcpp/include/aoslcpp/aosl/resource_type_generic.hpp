...
namespace aosl
{
  ...
  class Resource_type_generic: public ::xml_schema::String
  {
    ...
    {
      /**
       * Let the interpreter find automatically wich type of resource it is.
       */
      auto_,
      /**
    ...
    public:
    static const char* const _xsd_Resource_type_generic_literals_[5];
    static const Value _xsd_Resource_type_generic_indexes_[5];
