...
/**
 * @file
 * @brief Generated from axis_x.xsd.
 */

#ifndef AOSLCPP_AOSL__AXIS_X_HPP
#define AOSLCPP_AOSL__AXIS_X_HPP
...
{
  /**
   * @brief Class corresponding to the %axis_x schema type.
   *
   * Configuration of the horizontal x-axis.
   *
   * @nosubgrouping
   */
  class AOSLCPP_API Axis_x: public ::xml_schema::Type
  {
    public:
    /**
     * @name origin
     ...
     *
     * Position of the origin of the x-axis in the display.
     */
    //@{
     ...
     */
    typedef ::aosl::Axis_origin_x OriginType;
     ...
     * optional attribute with a default value.
     *
     * Side of the display where the x values are positive, relative to the
     * x-axis origin.
     */
    //@{
     ...
     * @brief Attribute type.
     */
    typedef ::aosl::Axis_positive_x PositiveType;
     ...
     * instance.
     */
    Axis_x (const ::xercesc::DOMElement& e,
  ...
  AOSLCPP_API
  bool
  operator== (const Axis_x&, const Axis_x&);
...
namespace aosl
{
  AOSLCPP_API
  ::std::ostream&
  operator<< (::std::ostream&, const Axis_x&);
}
...
namespace aosl
{
  AOSLCPP_API
  void
  operator<< (::xercesc::DOMElement&, const Axis_x&);
}
...
#endif // AOSLCPP_AOSL__AXIS_X_HPP
