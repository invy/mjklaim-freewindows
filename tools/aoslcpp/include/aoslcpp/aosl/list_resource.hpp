...
/**
 * @file
 * @brief Generated from list_resource.xsd.
 */

#ifndef AOSLCPP_AOSL__LIST_RESOURCE_HPP
#define AOSLCPP_AOSL__LIST_RESOURCE_HPP
...
{
  /**
   * @brief Class corresponding to the %list_resource schema type.
   *
   * List of Resources
   *
   * @nosubgrouping
   */
  class AOSLCPP_API List_resource: public ::xml_schema::Type
  {
    public:
    /**
     * @name resource
  ...
  AOSLCPP_API
  bool
  operator== (const List_resource&, const List_resource&);
...
namespace aosl
{
  AOSLCPP_API
  ::std::ostream&
  operator<< (::std::ostream&, const List_resource&);
}
...
namespace aosl
{
  AOSLCPP_API
  void
  operator<< (::xercesc::DOMElement&, const List_resource&);
}
...
#endif // AOSLCPP_AOSL__LIST_RESOURCE_HPP
