...
/**
 * @file
 * @brief Generated from axis_y.xsd.
 */

#ifndef AOSLCPP_AOSL__AXIS_Y_HPP
#define AOSLCPP_AOSL__AXIS_Y_HPP
...
{
  /**
   * @brief Class corresponding to the %axis_y schema type.
   *
   * Configuration of the horizontal y-axis.
   *
   * @nosubgrouping
   */
  class Axis_y: public ::xml_schema::Type
  {
     ...
     *
     * Position of the origin of the y-axis in the display.
     */
    //@{
     ...
     */
    typedef ::aosl::Axis_origin_y OriginType;
     ...
     * optional attribute with a default value.
     *
     * Side of the display where the y values are positive, relative to the
     * y-axis origin.
     */
    //@{
     ...
     * @brief Attribute type.
     */
    typedef ::aosl::Axis_positive_y PositiveType;
...
#endif // AOSLCPP_AOSL__AXIS_Y_HPP
