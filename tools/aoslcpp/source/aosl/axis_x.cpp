...
namespace aosl
{
  ...
  const Axis_x::OriginType Axis_x::origin_default_value_ (
    "left");

  const Axis_x::PositiveType Axis_x::positive_default_value_ (
    "right");
  ...
  {
    return new class Axis_x (*this, f, c);
  }
  ...
  bool
  operator== (const Axis_x& x, const Axis_x& y)
  {
...
{
  ::std::ostream&
  operator<< (::std::ostream& o, const Axis_x& i)
  {
...
{
  void
  operator<< (::xercesc::DOMElement& e, const Axis_x& i)
  {
