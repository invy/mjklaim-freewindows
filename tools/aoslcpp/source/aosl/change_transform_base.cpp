...
namespace aosl
{
  ...
  Change_transform_base* Change_transform_base::
  _clone (::xml_schema::Flags f,
          ::xml_schema::Container* c) const
  {
    return new class Change_transform_base (*this, f, c);
  }
  ...
  _xsd_Change_transform_base_comparison_init;
}
...
{
  ::std::ostream&
  operator<< (::std::ostream& o, const Change_transform_base& i)
  {
  ...
  static
  const ::xsd::cxx::tree::std_ostream_initializer< 0, char, Change_transform_base >
  _xsd_Change_transform_base_std_ostream_init;
}
...
{
  void
  operator<< (::xercesc::DOMElement& e, const Change_transform_base& i)
  {
