...
namespace aosl
{
         ...
         ::xml_schema::Flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // effect
      //
      if (n.name () == "effect" && n.namespace_ () == "http://artofsequence.org/aosl/1.x")
      {
  ...
  {
    return new class List_effect (*this, f, c);
  }
  ...
  bool
  operator== (const List_effect& x, const List_effect& y)
  {
...
{
  ::std::ostream&
  operator<< (::std::ostream& o, const List_effect& i)
  {
    for (List_effect::EffectConstIterator
...
{
  void
  operator<< (::xercesc::DOMElement& e, const List_effect& i)
  {
