...
namespace aosl
{
  ...
  const Canvas::AnglesType Canvas::angles_default_value_ (
    "degree");
         ...
         ::xml_schema::Flags f)
  {
    ...
    while (p.more_attributes ())
    {
      ...
      if (n.name () == "angles" && n.namespace_ ().empty ())
      {
        ::std::auto_ptr< AnglesType > r (
          AnglesTraits::create (i, f, this));
    ...
    if (!angles_.present ())
    {
      this->angles_.set (angles_default_value ());
    }
  }
