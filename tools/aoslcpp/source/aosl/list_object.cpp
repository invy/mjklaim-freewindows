...
namespace aosl
{
  ...
  {
    return new class List_object (*this, f, c);
  }
  ...
  bool
  operator== (const List_object& x, const List_object& y)
  {
    {
      ::xsd::cxx::tree::comparison_map< char >& cm (
        ::xsd::cxx::tree::comparison_map_instance< 0, char > ());

      List_object::ObjectSequence a (x.object ()), b (y.object ());

      if (a.size () != b.size ())
        return false;

      for (List_object::ObjectConstIterator
...
{
  ::std::ostream&
  operator<< (::std::ostream& o, const List_object& i)
  {
    {
...
{
  void
  operator<< (::xercesc::DOMElement& e, const List_object& i)
  {
    ...
    //
    {
      ...
      for (List_object::ObjectConstIterator
           ...
           b != n; ++b)
      {
        if (typeid (List_object::ObjectType) == typeid (*b))
        {
