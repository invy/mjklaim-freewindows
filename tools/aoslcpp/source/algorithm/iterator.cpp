...
namespace aoslcpp
{
	...
	void objects_iterator_depth::build( const aosl::List_object& root_objects )
	{
		add_nodes( root_objects, nullptr, 0 );
		
	}

	void objects_iterator_depth::add_nodes( const aosl::List_object& objects, const aosl::Object* parent, size_t depth )
	{
	...
	void objects_iterator_breadth::build( const aosl::List_object& root_objects )
	{
		NodePath path;
